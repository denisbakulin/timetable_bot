...
SETTINGS_TEXT = (
    ...
    "Сохрани несколько групп и быстро переключайся между ними.\n\n"
    ...
    "⏳ <b>Напоминание до пары: {lesson_notify_minutes}</b>\n"
    "Включи напоминание, чтобы бот предупреждал перед началом ближайшей пары."
)
...
ADMIN_HELP_TEXT = (
    ...
    "• по названию (если уже в БД): <code>/add_group БИЭ24-01</code>\n\n"
    "<b>/refresh_group</b>\n"
    "• обновить id/диапазон: <code>/refresh_group 13887-13910</code>\n\n"
    "• обновить по названию (если уже в БД): <code>/refresh_group БИЭ24-01</code>\n\n"
